...
import numpy as np
import torch
from utils import perform_val_bin_onnx
...
def parse_args():
    ...
    parser.add_argument('--data_root', default='/home/hbj/dataset/faces_web_mask2p_final',  help='validation data root')
...
def main():
    ...
    # load data
    lfw, cfp_fp, agedb_30, rmfrd, \
        lfw_issame, cfp_fp_issame, agedb_30_issame, \
        rmfrd_issame = get_val_data_from_bin(val_data_dir)
    # load backbone
    ...
    print("Perform Evaluation on LFW, CFP_FP, RMFRD ...")
    # LFW result
    accuracy_lfw, best_threshold_lfw = perform_val_bin_onnx(
        args.embedding_size,
        args.batch_size,
        backbone,
        lfw,
    ...
    # CFP-FP result
    accuracy_cfp_fp, best_threshold_cfp_fp = perform_val_bin_onnx(
        args.embedding_size,
        args.batch_size,
        backbone,
        cfp_fp,
    ...
    accuracy_agedb, best_threshold_agedb = perform_val_bin_onnx(
        args.embedding_size,
        args.batch_size,
        backbone,
        agedb_30,
    ...
    accuracy_rmfrd, best_threshold_rmfrd = perform_val_bin_onnx(
        args.embedding_size,
        args.batch_size,
        backbone,
        rmfrd,
        rmfrd_issame)
    # RMFRD result
    print("Evaluation: RMFRD Acc: {}, thresh: {}".format(accuracy_rmfrd, best_threshold_rmfrd))
